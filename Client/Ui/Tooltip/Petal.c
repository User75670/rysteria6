...
struct rr_ui_element *rr_ui_petal_tooltip_init(uint8_t id, uint8_t rarity)
{
    ...
    else if (id == rr_petal_id_quetz_egg)
    {
        rr_ui_container_add_element(
            this, rr_ui_set_justify(
                      rr_ui_h_container_init(
    ...
    else if (id == rr_petal_id_trice_egg)
    {
        rr_ui_container_add_element(
            this, rr_ui_set_justify(
                      rr_ui_h_container_init(
                          ...
                          rr_ui_text_init(
                              RR_RARITY_NAMES[rarity >= 1 ? rarity - 1 : 0], 12,
                              RR_RARITY_COLORS[rarity >= 1 ? rarity - 1 : 0]),
                          rr_ui_text_init(" Triceratops", 12, 0xffffffff), NULL),
                      -1, 0));
    }
            ...
            this, rr_ui_set_justify(
                      rr_ui_h_container_init(
                          ...
                          rr_ui_text_init(
                              RR_RARITY_NAMES[rarity >= 1 ? rarity - 1 : 0], 12,
                              RR_RARITY_COLORS[rarity >= 1 ? rarity - 1 : 0]),
                          rr_ui_text_init(" Edmontosaurus", 12, 0xffffffff), NULL),
                      -1, 0));
    }
    else if (id == rr_petal_id_fern_egg)
    {
        rr_ui_container_add_element(
            this, rr_ui_set_justify(
                      rr_ui_h_container_init(
            ...
            this, rr_ui_set_justify(
                      rr_ui_h_container_init(
                          ...
                          rr_ui_text_init(
                              RR_RARITY_NAMES[rarity >= 1 ? rarity - 1 : 0], 12,
                              RR_RARITY_COLORS[rarity >= 1 ? rarity - 1 : 0]),
                          rr_ui_text_init(" Ankylosaurus", 12, 0xffffffff), NULL),
                      -1, 0));
    }
    else if (id == rr_petal_id_orni_egg)
    {
        rr_ui_container_add_element(
            this, rr_ui_set_justify(
                      rr_ui_h_container_init(
