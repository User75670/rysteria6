                             ...
                             struct rr_simulation *simulation)
{
    ...
    if ((mob->id == rr_mob_id_trex || mob->id == rr_mob_id_meteor || mob->id == rr_mob_id_dakotaraptor || mob->id == rr_mob_id_pteranodon || mob->id == rr_mob_id_pachycephalosaurus || mob->id == rr_mob_id_quetzalcoatlus) &&
        is_friendly)
