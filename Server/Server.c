...
#ifndef SANDBOX
            if (
                strcmp(client->rivet_account.uuid, "dc04d57b-2a96-4dcf-869e-8811c2e2932e") == 0
             || strcmp(client->rivet_account.uuid, "461ff5cf-3690-459b-ae3f-dfae45924abf") == 0
          // || strcmp(client->rivet_account.uuid, "") == 0
          //  strcmp(client->rivet_account.uuid,   "") == 0
            )
#endif
                client->dev = 1;
