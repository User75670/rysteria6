...
{
    return rr_frand() > 0.03 ? rr_mob_id_pteranodon : rr_mob_id_meteor;
}
...
static struct zone zone_positions[ZONE_POSITION_COUNT] = {
    ...
    {27,25, 13, 15, garden_zone},
    {23,33, 4, 7, garden_zone},
    ...
    {37,23, 2, 3, hornet_bee_beehive_zone},
};
